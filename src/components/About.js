...
const About = () => {
    ...
    return <section className='py-[80px] md:py-[110px] lg:pt-[140px] lg:pb-[180px]'>
        <div className='container mx-auto px-[20px] lg:px-[135px]'>
            ...
            {/******------subtitle1------******/}
            <p className='md:text-body-md mb-12' data-aos='fade-up' data-aos-delay='200'>
                {subtitle1}
            </p>
            {/******------subtitle2------******/}
            <p className='md:text-body-md mb-8' data-aos='fade-up' data-aos-delay='300'>
                {subtitle2}
            </p>
            {/******------link------******/}
            <div data-aos='fade-up' data-aos-delay='400'>
                <a className='link flex item-center gap-x-4 hover:gap-x-6 transition-all' href="#">
                    {link}
