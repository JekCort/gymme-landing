...
const Join = () => {
  const { image, btnText, subtitle, title} = join
  return <section className='bg-neutral-500
  min-h-[537px]'>
    <div className="container mx-auto">
      {/******------image and text wrapper------******/}
      <div className='flex flex-col md:flex-row md:items-center md:-space-x-12 -space-y-24 lg:-space-y-0'>
        {/******------image------******/}
        <div className='-mt-[80px] max-w-[276px] md:max-w-[440px] lg:max-w-full'
        data-aos='fade-right'
        data-aos-offset='100'
        data-aos-delay='200'
        >
        ...
        <div className='max-w-[350px] lg:max-w-[492px] ml-[30px]'
          ...
          <p className='text-body-sm md:text-body-md text-white mb-4 lg:mb-6 max-w-[340px] md:max-w-[470px] lg:max-w-[492px]'>{subtitle}</p>
