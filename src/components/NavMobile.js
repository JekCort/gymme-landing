...
const NavMobile = ({navMobile}) => {
  ...
  return <nav className={`${navMobile ? 'min-h-screen' : 'min-h-0'} lg:hidden w-full bg-neutral-500 fixed top-0 left-0 -bottom-12 -z-10 overflow-hidden transition-all h-0`}>
